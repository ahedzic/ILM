...
from torch_geometric.nn import RGATConv, RGCNConv, GCNConv, SAGEConv, GINConv, GATConv
    ...
    def __init__(self, in_channels, hidden_channels, num_relations, out_channels, num_layers,
        ...
        if data_name == 'ogbl-citation2':
            if num_layers == 1:
                ...
                self.convs.append(RGCNConv(hidden_channels, out_channels, normalize=False))
