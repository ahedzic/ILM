...
# ILM(RGCN)
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_relational_ilm.py --data_name starcraft --input_size 25 --gnn_model RGCN --lr 0.001 --dropout 0.3 --l2 1e-7 --num_relations 3 --num_layers 2 --hidden_channels 128 --num_layers_predictor 2 --epochs 9999 --kill_cnt 3 --eval_steps 5 --runs 10 --iterations 1 --weights meta --cold_perc 0.0 > iterations/output_starcraft_ilm_rgcn_1_iterations
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_relational_ilm.py --data_name starcraft --input_size 25 --gnn_model RGCN --lr 0.001 --dropout 0.3 --l2 1e-7 --num_relations 3 --num_layers 2 --hidden_channels 128 --num_layers_predictor 2 --epochs 9999 --kill_cnt 3 --eval_steps 5 --runs 10 --iterations 2 --weights meta --cold_perc 0.0 > iterations/output_starcraft_ilm_rgcn_2_iterations
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_relational_ilm.py --data_name starcraft --input_size 25 --gnn_model RGCN --lr 0.001 --dropout 0.3 --l2 1e-7 --num_relations 3 --num_layers 2 --hidden_channels 128 --num_layers_predictor 2 --epochs 9999 --kill_cnt 3 --eval_steps 5 --runs 10 --iterations 3 --weights meta --cold_perc 0.0 > iterations/output_starcraft_ilm_rgcn_3_iterations
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_relational_ilm.py --data_name starcraft --input_size 25 --gnn_model RGCN --lr 0.001 --dropout 0.3 --l2 1e-7 --num_relations 3 --num_layers 2 --hidden_channels 128 --num_layers_predictor 2 --epochs 9999 --kill_cnt 3 --eval_steps 5 --runs 10 --iterations 4 --weights meta --cold_perc 0.0 > iterations/output_starcraft_ilm_rgcn_4_iterations
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_relational_ilm.py --data_name starcraft --input_size 25 --gnn_model RGCN --lr 0.001 --dropout 0.3 --l2 1e-7 --num_relations 3 --num_layers 2 --hidden_channels 128 --num_layers_predictor 2 --epochs 9999 --kill_cnt 3 --eval_steps 5 --runs 10 --iterations 5 --weights meta --cold_perc 0.0 > iterations/output_starcraft_ilm_rgcn_5_iterations
...
# ILM(RGAT)
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_relational_ilm.py --data_name yelp --input_size 300 --gnn_model RGAT --lr 0.001 --dropout 0.1 --l2 1e-7 --num_relations 1 --num_layers 3 --hidden_channels 128 --num_layers_predictor 3 --epochs 9999 --kill_cnt 3 --eval_steps 5 --runs 10 --iterations 3 --weights meta --cold_perc 0.0 > iterations/output_yelp_ilm_rgat_3_iterations

# Leroy
CUBLAS_WORKSPACE_CONFIG=:4096:8 python main_cold_leroy.py --data_name yelp --model Leroy --epochs 1 --kill_cnt 1 --eval_steps 1 --runs 1 --cold_perc 0.0 > iterations/output_yelp_leroy
